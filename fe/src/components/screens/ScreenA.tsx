    ...
    <div className="min-h-screen bg-background p-6 md:p-8 flex flex-col overflow-y-auto pb-10">
      <div className="max-w-7xl mx-auto w-full flex-grow flex flex-col">
        ...
        <FadeIn delay={100} className="flex-1 lg:min-h-0">
          <div className="flex flex-col lg:flex-row w-full gap-6 h-auto lg:h-full items-center">
            <div className="w-full lg:w-1/2 flex items-center justify-center min-h-[400px] lg:min-h-0">
              <div className="transform scale-[0.6] md:scale-75 lg:scale-100 transition-transform">
                <ScoreGauge percentage={data.score} status={data.status} />
              </div>
            </div>

            <div className="w-full lg:w-1/2 flex items-center justify-center min-h-[500px] lg:h-full">
              <ComparativeChart
                score={data.score}
